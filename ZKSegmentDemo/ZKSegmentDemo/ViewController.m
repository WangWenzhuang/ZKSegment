...
- (void)viewDidLoad {
    ...
    self.msgLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 250, self.view.frame.size.width, 25)];
...
- (void)resetSegment {
    ...
    self.zkSegment = [ZKSegment zk_segmentWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, 45) style:self.zkSegmentStyle];
    // 可手动设置各种颜色；
    // 如不设置则使用默认颜色
